...
export default function NotFound() {
    return (
        <div className="flex flex-col min-h-[100vh] bg-black text-white items-center justify-center space-y-4 text-center">
            ...
            <Link
                className="inline-flex h-9 items-center font-semibold text-black justify-center rounded-md border border-gray-200 bg-white px-4 text-sm shadow-sm transition-colors hover:bg-gray-100 hover:text-gray-900 dark:border-gray-800 dark:bg-gray-950 dark:hover:bg-gray-800 dark:hover:text-gray-50 dark:focus-visible:ring-gray-300"
                href={PATH_URL.MAIL_BOX}
            >
